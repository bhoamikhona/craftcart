  ...
  return (
    <div className="space-y-5">
      <div>
        <h3 className="text-lg font-semibold text-gray-900">Steps</h3>
        <p className="text-sm text-gray-600 mt-1">
          Write quick, friendly steps your viewers can follow like a checklist
          ✨
        </p>
      </div>
      ...
      <div className="space-y-2">
        {video.steps.map((s) => (
          ...
          >
            {/* left accent */}
            <div className="absolute left-0 top-2 bottom-2 w-[3px] rounded-full bg-orange-500/80" />

            {/* number */}
            <div className="ml-1 h-7 w-7 rounded-full bg-orange-100 text-orange-700 flex items-center justify-center text-xs font-semibold shrink-0">
              {s.number}
            </div>
      ...
      {/* Add row */}
      <div className="rounded-2xl bg-white border border-gray-200 px-3 py-2 flex items-center gap-3">
        <div className="h-9 w-9 rounded-xl border border-gray-200 bg-white flex items-center justify-center text-orange-600">
          <Plus size={16} />
        </div>
